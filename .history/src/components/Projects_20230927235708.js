  ...
  return(
   <section id='projects' className='section'>
    <div className='container mx-auto'>
      {/* Text / Images */}
      <div className='flex-1 lg:bg-services lg:bg-bottom bg-'>
        <h2 className='h2 text-accent mb-6'>
          Overall Experience.
        </h2>
        <h3 className='h3 max-w-[455px] mb-16'>
          I have 2+ years of Experience with HTML, CSS, JavaScript.<br></br>
          I have 3+ years of Experience with Java. <br></br>
