...
const projects = [
  {
    name: 'Agri-Grow',
    description:
    'This is the Final Project made for my BSc Software Engineering Dissertation. This Project is an Intelligent Plant Health Monitoring System. Agri-Grow is built in order to determine Diseases that Affect Paddy (Crop) Plants based on: MINERAL DEFICIENCIES DETECTION, PATHOGENIC DISEASE DETECTION, PEST DISEASE DETECTION.Based on the Detections; a Yield Enhancement Recommendation would be given.',
