...
const About = () => {
  ...
  <section id='about' className='section' ref={ref}>
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-10 lg:flex-row lg:item'>
        {/* Image */}
        ...
        <div className='flex-1'>
          ...
          <h3 className='h3 mb-4'>I'm a final year undergraduate following BSc (Hons) Software Engineering.</h3>
            <p className='mb-6'>
