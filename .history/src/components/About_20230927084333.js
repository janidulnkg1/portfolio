      ...
      <div>
        ...
        <div>
          ...
          <h3>I'm a final year undergraduate following BSc (Hons) Software Engineering. 
            ...
            frontend technologies (HTML5, CSS3, JavaScript: JQuery/ AJAX, php, React.js/Typescript etc.) as well as Machine learning and Artificial intelligence. I enjoy working on a wide range of projects and constantly expanding my skill set.</h3>
        </div>
      </div>
    </div>
